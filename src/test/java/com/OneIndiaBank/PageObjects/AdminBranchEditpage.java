...
public class AdminBranchEditpage {
protected WebDriver local_driver;
	...
	public AdminBranchEditpage(WebDriver remote_driver)
	{
	...
	public void update_branch(int row)
	{
		try {
		select_edit.get(row).click();
		}
		catch(Exception x)
		{
	...
	public void Select_edit_button(int value) 
	{
		select_edit.get(value).click();
	}
